...
# Generated from 3.3 _ACQuire Commands.toml
# -------------------------------------------------
...
class Acquire:
    ...
    def memory_depth(self, value: str = None):
        ...
        if value is None:
            ...
            allowed_values = ['AUTO', '1K', '10K', '100K', '1M', '10M', '25M', '50M']
    ...
    def acq_type(self, value: str = None):
        ...
        if value is None:
            ...
            allowed_values = ['NORMAL', 'PEAK', 'AVERAGES', 'ULTRA']
            if str(value).upper() not in allowed_values:
...
class Ultra:
    ...
    def mode(self, value: str = None):
        ...
        if value is None:
            ...
            allowed_values = ['ADJACENT', 'OVERLAY', 'WATERFALL', 'PERSPECTIVE', 'MOSAIC']
            if str(value).upper() not in allowed_values:
    ...
    def timeout(self, value: float = None):
        ...
        if value is None:
            ...
            if value < 1e-06 or value > 10.0:
                return "ERROR: Value must be between 1e-06 and 10.0"
